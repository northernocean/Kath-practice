...
//Read the data
d3.csv("Production+Consumption"), function(data) 
    ...
    var x = d3.scaleLinear()
      .domain(d3.extent(data, function(d) { return d.year_id-2; }))
      .range([ 0, width ]);
    svg.append("g")
    ...
    var line = svg
      ...
      .append("path")
        ...
        .attr("d", d3.line()
          .x(function(d) { return x(d.year_id-2) })
          .y(function(d) { return y(+d.energy_consumption_pj) })
        )
